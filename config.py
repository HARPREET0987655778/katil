...
OWNER_NAME = getenv("OWNER_NAME", "KATIL")
OWNER_USERNAME = getenv("OWNER_USERNAME", "KATTAR_HINDU_KATIL")
ALIVE_NAME = getenv("ALIVE_NAME", "NIKKU")
BOT_USERNAME = getenv("nikkurobot")
ASSISTANT_NAME = getenv("NIKKI")
GROUP_SUPPORT = getenv("World_friends_chatting_hub")
UPDATES_CHANNEL = getenv("heartbrokenperson1")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5052381560").split()))
